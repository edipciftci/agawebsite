    ...
    <div className="space-y-10">
      ...
      <section className="rounded-2xl border bg-white/70 p-6 backdrop-blur">
        ...
        <p className="mt-2 max-w-2xl text-sm opacity-80">
          Anasayfa açılış metni. Burada kısa bir paragraf var, belki de bir
          slogan var. Çok uzun değil. Ama ikinci satıra inecek kadar uzun.
          Metnin bitiş cümlesi.
        </p>
